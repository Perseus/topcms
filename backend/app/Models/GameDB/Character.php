...
class Character extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\GameDB\Account::class,'act_id');
    }
    ...
    {
        return $this->hasMany(\App\Models\GameDB\Item::class);
    }
    /**
    ...
    {
        return $this->hasOne(\App\Models\GameDB\Guild::class);
    }
